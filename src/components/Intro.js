  ...
  return (
    ...
    >
        ...
        >
            <Center m={4}>
                <Avatar
                    src={require('../images/mexxxxx.webp')}
                    boxSize="75px"
            ...
            >
                ...
                <Text as="cite" w="100" mb={3}  textAlign="right" fontSize={"xs"}>Karl Sunogan, 2022</Text>
            </Stack>
            <Stack
                borderRadius="lg"
                maxW={"xl"}
            ...
            >
                {
                    aboutMe.map(my => {
                        return (
                            <ListItem fontSize={13} key={my.id}>
        ...
        >
            ...
            <List fontSize={13}>
                <ListItem>
                    My experience of operating the software tools is an opportunity 
